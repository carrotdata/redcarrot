...
#include "com_carrotdata_compression_lz4_LZ4.h"
/* Header for class com_carrotdata_compression_lz4_LZ4 */
...
extern "C" {
#endif
    /*
     * Class:     com_carrotdata_compression_lz4_LZ4
     * Method:    compress
     * Signature: ([B)[B
     */
    JNIEXPORT jbyteArray JNICALL Java_com_carrotdata_compression_lz4_LZ4_compress
     ...
     * Signature: ([B)[B
     */
    JNIEXPORT jbyteArray JNICALL Java_com_carrotdata_compression_lz4_LZ4_decompress
     ...
     */
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_compressDirect
   ...
   /*
     ...
     */
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_compressDirectHC
    ...
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_compressDirectAddress
     ...
     */
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_decompressDirect
     ...
     * Signature: (Ljava/nio/ByteBuffer;ILjava/nio/ByteBuffer;I)I
     */
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_decompressDirectHC
    (JNIEnv *env, jclass clz, jobject srcBuffer, jint offset, jint compressedSize, jobject dstBuffer,
     jint where, jint dstCapacity)
    {

        return Java_com_carrotdata_compression_lz4_LZ4_decompressDirect(env, clz, srcBuffer, offset, compressedSize, dstBuffer,
         where, dstCapacity);

    }

    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_decompressDirectAddress
    ...
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_compressDirectAddressHC
    ...
    JNIEXPORT jint JNICALL Java_com_carrotdata_compression_lz4_LZ4_decompressDirectAddressHC
    (JNIEnv *env, jclass cls, jlong src, jint compressedSize, jlong dst, 
    jint dstCapacity)
    {
        return Java_com_carrotdata_compression_lz4_LZ4_decompressDirectAddress(env, cls, src, 
