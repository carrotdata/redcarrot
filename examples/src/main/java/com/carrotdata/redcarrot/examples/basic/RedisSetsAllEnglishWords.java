 ...
 * <p>
 * 1) No compression 24.3M/4.3M ~ 5.7x 2) LZ4 compression 24.3M/2.8M ~ 8.4x 3) LZ4HC compression
 * 24.3M/2.6M ~ 9.0x
 */
public class RedisSetsAllEnglishWords {
  ...
  private static void usage() {
    log.fatal(
      "usage: java com.carrotdata.redcarrot.examples.RedisSetsAllEnglishWords word_list_file");
    System.exit(-1);
  }
}
