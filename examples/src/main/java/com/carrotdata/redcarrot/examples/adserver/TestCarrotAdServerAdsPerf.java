 ...
 * Results:
 * <p>
 * Redis 7.2.4 = 1,527,734,024 Carrot no compression = 652,325,376 Carrot LZ4 compression =
 * 476,455,424 Carrot ZSTD compression = 364,447,872 Memory ratio Redis/Carrot: 1. Carrot no
 * compression ~ 2.34x 2. Carrot LZ4 ~ 3.2x 3. Carrot ZSTD ~ 4.2x
 * <p>
 * Notes:
 * <p>
 * 1. The test uses synthetic data, which is mostly random and not compressible 2. For AdSitePerf
