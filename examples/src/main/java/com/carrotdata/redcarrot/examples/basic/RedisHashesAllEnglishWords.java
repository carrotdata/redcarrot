 ...
 * NoCompression - RAM usage 4,306,191, COMPRESSION = 0.81 3 Carrot LZ4 compression - RAM usage
 * 2,857,311, COMPRESSION = 1.22 4. Carrot LZ4HC compression - RAM usage 2,601,695, COMPRESSION =
 * 1.34
 * <p>
 ...
 * <p>
 * 1) No compression 24.3M/3.5M ~ 6.9x 2) LZ4 compression 24.3M/2.8M ~ 8.4x 3) LZ4HC compression
 * 24.3M/2.6M ~ 9.0x
 * <p>
 * Redis Hashes RAM usage is ~6,140,000
 * <p>
 * 1) No compression 5.1M/3.5M ~ 1.5x 2) LZ4 compression 5.1M/2.8M ~ 1.8x 3) LZ4HC compression
 * 5.1M/2.6M ~ 2.0x
 */
public class RedisHashesAllEnglishWords {
  ...
  private static void usage() {
    log.fatal(
      "usage: java com.carrotdata.redcarrot.examples.RedisHashesAllEnglishWords domain_list_file");
    System.exit(-1);
  }
}
