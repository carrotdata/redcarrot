 ...
 * <p>
 * 1) No compression 116/53 ~ 2.2x 2) LZ4 compression 116/34 ~ 3.4x 3) LZ4HC compression 116/30 =
 * 3.9x
 * <p>
 * Effect of a compression:
 * <p>
 * LZ4 - 53/34 ~ 1.6x (to no compression) LZ4HC - 53/30 ~ 1.8x (to no compression)
 */
public class RedisZSetsDenialOfService {
  ...
  private static void runTest() throws IOException {
    ...
    log.debug("Loaded {} [host, number] pairs, total size={} in {}ms. Press any button ...", num,
      totalDataSize, endTime - startTime);
    System.in.read();
