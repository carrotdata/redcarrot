...
public class TestZLEXCOUNT extends CommandBase {
  ...
  protected String[] invalidRequests = new String[] { "zlexcoun x y", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: ZLEXCOUN\r\n",
