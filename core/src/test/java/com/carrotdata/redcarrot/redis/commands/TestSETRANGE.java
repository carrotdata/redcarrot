...
public class TestSETRANGE extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "SETRANGE key 0 1234567890", /* 10 */
      "STRLEN key", /* 10 */
      "GET key", /* 1234567890 */
  ...
  protected String[] invalidRequests = new String[] { "setrang x y", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SETRANG\r\n",
