...
public class TestZRANGEBYLEX extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "ZADD key 0 c1 0 c2 0 c3 0 c4 0 c5", /* 5 */
  ...
  protected String[] invalidRequests = new String[] { "zrangebyle x y", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: ZRANGEBYLE\r\n",
