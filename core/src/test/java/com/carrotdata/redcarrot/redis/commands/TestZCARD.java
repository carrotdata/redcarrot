...
public class TestZCARD extends CommandBase {
  ...
  protected String[] validRequests = new String[] {
      ...
      "ZCARD key", /* 14 */
      "ZADD key XX CH 12345 v11 1.9E-6 v21 0.123 v51 12.15 v61 1.0 v71 2.0 v81 22.0 v9 11.0 v10 ", /*
                                                                                                    * 1
                                                                                                    */
      "ZCARD key", /* 14 */
      "ZADD key NX CH 1234 v11 1.9E-6 v21 0.123 v51 12.15 v61 1.0 v71 2.0 v81 22.0 v9 11.0 v10", /*
                                                                                                  * 2
                                                                                                  */
      "zcard key" /* 16 */
  };
  ...
  protected String[] invalidRequests = new String[] { "zcardd x y", /* unsupported command */
      "ZCARD", /* wrong number of arguments */
      "ZCARD key 1", /* wrong number of arguments */
      "ZCARD key 1 2 3", /* wrong number of arguments */
      "ZCARD key A 2" /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: ZCARDD\r\n",
