...
public class TestZRANGEBYSCORE extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "ZADD key 0.0 c1 1.0 c2 2.0 c3 3.0 c4 4.0 c5", /* 5 */
  ...
  protected String[] invalidRequests = new String[] { "zrangebyscor x y", /* unsupported command */
  ...
  protected String[] invalidResponses =
      new String[] { "-ERR: Unsupported command: ZRANGEBYSCOR\r\n",
