...
public class TestSET extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "SET key value", /* OK */
      ...
      "set key value px 1000 nx get", "set key value px 1000 xx get",
      "SET key9 value PX 1000 NX GET", "SET key9 value PX 1000 XX GET",
      "set key value exat 1000 nx get", "set key value exat 1000 xx get",
      "SET key10 value EXAT 1000 NX GET", "SET key10 value EXAT 1000 XX GET",
      "set key value pxat 1000 nx get", "set key value pxat 1000 xx get",
      "SET key11 value PXAT 1000 NX GET", "SET key11 value PXAT 1000 XX GET",
      "set key value keepttl nx get", "set key value keepttl xx get",
      "SET key12 value KEEPTTL NX GET", "SET key12 value KEEPTTL XX GET" };
  ...
  protected String[] invalidRequests = new String[] { "sett x y", /* unsupported command */
      ...
      "SET key value NX GET PX 1000", "SET key value GET PX 1000 XX",
      "SET key9 value PX 1000 GET NX", "SET key9 value XX PX 1000 GET" };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SETT\r\n",
