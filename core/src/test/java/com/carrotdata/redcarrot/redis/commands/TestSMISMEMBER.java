...
public class TestSMISMEMBER extends CommandBase {
  ...
  protected String[] invalidRequests = new String[] { "smismembe x y", /* unsupported command */
      "SMISMEMBER", /* wrong number of arguments */
      "SMISMEMBER x", /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SMISMEMBE\r\n",
