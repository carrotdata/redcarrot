...
public class TestSETBIT extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "SETBIT key 100 1", /* 0 */ "setbit key 100 0",
      /* 1 */ "STRLEN key" /* 13 */ };

  protected String[] validResponses = new String[] { ":0\r\n", ":1\r\n", ":13\r\n" };

  protected String[] invalidRequests = new String[] { "setbi x y", /* unsupported command */
      ...
      "SETBIT key 100 a", "SETBIT key 100 2" };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SETBI\r\n",
