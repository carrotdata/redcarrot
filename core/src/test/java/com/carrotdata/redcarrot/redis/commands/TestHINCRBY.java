...
public class TestHINCRBY extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "HSET key field1 100 field2 200",
      "HINCRBY key field1 100", "HINCRBY key field2 100", "hincrby key field3 100" };

  protected String[] validResponses = new String[] { ":2\r\n", ":200\r\n", ":300\r\n", ":100\r\n" };

  protected String[] invalidRequests = new String[] { "HINCRBY", /* wrong number of arguments */
