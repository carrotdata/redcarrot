...
public class TestSSETBIT extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "SSETBIT key 100 1", /* 0 */ "ssetbit key 100 0" /* 1 */ };

  protected String[] validResponses = new String[] { ":0\r\n", ":1\r\n" };

  protected String[] invalidRequests = new String[] { "ssetbi x y", /* unsupported command */
      ...
      "SSETBIT key 100 a", "SSETBIT key 100 2", "SSETBIT key -100 2" };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SSETBI\r\n",
