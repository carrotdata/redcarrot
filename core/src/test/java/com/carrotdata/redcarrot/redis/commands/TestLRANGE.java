...
public class TestLRANGE extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "RPUSH key v0 v1 v2 v3 v4 v5 v6 v7 v8 v9", /*
                                                                                                * 10
                                                                                                */
  ...
  protected String[] invalidRequests = new String[] { "lrang x y", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: LRANG\r\n",
