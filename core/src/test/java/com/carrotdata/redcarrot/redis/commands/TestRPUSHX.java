...
public class TestRPUSHX extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "RPUSHX key v1 v2 v3 v4 v5 v6 v7 v8 v9 v10", /*
                                                                                                  * -1
                                                                                                  */
  ...
  protected String[] invalidRequests = new String[] { "rpushxx x y", /* unsupported command */
      "RPUSHX", /* wrong number of arguments */
      "RPUSHX key", /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: RPUSHXX\r\n",
