...
public class TestZREVRANGE extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "ZADD key 9.0 c0 8.0 c1 7.0 c2 6.0 c3 5.0 c4", /* 5 */
  ...
  protected String[] invalidRequests = new String[] { "zrevrang x y", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: ZREVRANG\r\n",
