...
public class TestINCRBY extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "INCRBY key 100", "INCRBY key 100", "incrby key 100" };

  protected String[] validResponses = new String[] { ":100\r\n", ":200\r\n", ":300\r\n", };

  protected String[] invalidRequests = new String[] { "incrb x", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: INCRB\r\n",
