...
public class TestMGET extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "MSET key1 value1 key2 value2 key3 value3 key4 value4", /* OK */
  ...
  protected String[] invalidRequests =
      new String[] { "mge x", /* unsupported command */ "MGET" /* Wrong number of arguments */ };

  protected String[] invalidResponses =
      new String[] { "-ERR: Unsupported command: MGE\r\n", "-ERR: Wrong number of arguments\r\n" };
