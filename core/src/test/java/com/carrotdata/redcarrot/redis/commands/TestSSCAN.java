...
public class TestSSCAN extends CommandBase {
  ...
  protected String[] validRequests = new String[] {
      ...
      "SSCAN key 1", "SSCAN key 2", "SSCAN key 3", "SSCAN key 4", "sscan key 0 count 11",
      "SSCAN key 6 COUNT 11", "SSCAN key 7 COUNT 11", "SSCAN key 8 COUNT 11",
      "SSCAN key 9 COUNT 11",
      // Scan all which start with 'a'
      "sscan key 0 match ^a.* count 10", "SSCAN key 11 MATCH ^a.* COUNT 10",
  ...
  protected String[] invalidRequests = new String[] { "SSCAN", /* wrong number of arguments */
