...
public class TestSPOP extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "SADD key v0 v1 v2 v3 v4 v5 v6 v7 v8 v9", /*
                                                                                               * 10
                                                                                               */
      "SPOP key 10", "SCARD key", /* 0 */
      "SADD key v0 v1 v2 v3 v4 v5 v6 v7 v8 v9", /* 10 */
      "SPOP key 100", "SCARD key", /* 0 */
      "SADD key v0 v1 v2 v3 v4 v5 v6 v7 v8 v9", /* 10 */
      "SPOP key 0", /* ERR - Positive number expected */
      "SPOP key -1", /* ERR - Positive number expected */
      "SPOP key1 2", /* empty array */
      "SCARD key", /* 10 */
      "SPOP key", "SCARD key", /* 9 */
      "spop key 5", "SCARD key", /* 4 */
  };
  ...
  protected String[] invalidRequests = new String[] { "spo x", /* unsupported command */
  ...
  protected String[] invalidResponses =
      new String[] { "-ERR: Unsupported command: SPO\r\n", "-ERR: Wrong number of arguments\r\n",
