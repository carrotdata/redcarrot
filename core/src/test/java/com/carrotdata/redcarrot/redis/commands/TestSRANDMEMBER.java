...
public class TestSRANDMEMBER extends CommandBase {
  ...
  protected String[] invalidRequests = new String[] { "srandmembe x", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SRANDMEMBE\r\n",
