...
public class TestHINCRBYFLOAT extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "HSET key field1 100 field2 200", "HINCRBYFLOAT key field1 100.1",
          "HINCRBYFLOAT key field2 100.1", "hincrbyfloat key field3 100.1" };

  protected String[] validResponses =
      new String[] { ":2\r\n", "$5\r\n200.1\r\n", "$5\r\n300.1\r\n", "$5\r\n100.1\r\n" };

  protected String[] invalidRequests = new String[] { "HINCRBYFLOAT", /*
