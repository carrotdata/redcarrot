...
public class TestGETEXPIRE extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "SET key value PXAT 123456789", /* OK */
      "SET key1 value", /* OK */
  ...
  protected String[] invalidRequests = new String[] { "GETEXPIRE", /* wrong number of arguments */
