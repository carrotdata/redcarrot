...
public class TestZCOUNT extends CommandBase {
  ...
  protected String[] invalidRequests = new String[] { "zcountt x y", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: ZCOUNTT\r\n",
