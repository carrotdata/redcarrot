...
public class TestRPOPLPUSH extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "RPUSH key1 v11 v12 v13 v14 v15", /* 5 */
  ...
  protected String[] invalidRequests = new String[] { "rpoplpus x y", /* unsupported command */
      "RPOPLPUSH", /* wrong number of arguments */
      "RPOPLPUSH x", /* wrong number of arguments */
      "RPOPLPUSH x y z", /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: RPOPLPUS\r\n",
