...
public class TestLREM extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "RPUSH key v1 v2 v1 v2 v1 v2 v1 v2 v1 v2", /*
                                                                                                * 10
                                                                                                */
      // Test negatives
      "LREM key 0 v3", /* 0 */
  ...
  protected String[] invalidRequests = new String[] { "lre x y", /* unsupported command */
  ...
  protected String[] invalidResponses =
      new String[] { "-ERR: Unsupported command: LRE\r\n", "-ERR: Wrong number of arguments\r\n",
          "-ERR: Wrong number of arguments\r\n", "-ERR: Wrong number of arguments\r\n",
