...
public class TestZSCORE extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "ZADD key 1234 v1 1.9E-6 v2 0.123 v3 12.15 v4", /* 4 */
          ...
          "ZSCORE key v7", /* NULL */
          "ZSCORE key1 v7", /* NULL */
          "ZADD key -inf v7", "ZADD key +inf v8", "ZSCORE key v7", "zscore key v8" };
  ...
  protected String[] invalidRequests = new String[] { "zscoree x y", /* unsupported command */
      "ZSCORE", /* wrong number of arguments */
      "ZSCORE key 1 2 3", /* wrong number of arguments */
      "ZSCORE key A 2" /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: ZSCOREE\r\n",
