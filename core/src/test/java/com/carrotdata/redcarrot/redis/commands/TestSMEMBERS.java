...
public class TestSMEMBERS extends CommandBase {
  ...
  protected String[] invalidRequests = new String[] { "smember x y", /* unsupported command */
      "SMEMBERS", /* wrong number of arguments */
      "SMEMBERS x v", /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: SMEMBER\r\n",
