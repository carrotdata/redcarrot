...
public class TestINCRBYFLOAT extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "INCRBYFLOAT key 100.5", "INCRBYFLOAT key 100.1", "incrbyfloat key 100.2" };

  protected String[] validResponses =
      new String[] { "$5\r\n100.5\r\n", "$5\r\n200.6\r\n", "$5\r\n300.8\r\n" };

  protected String[] invalidRequests = new String[] { "incrbyfloa x", /* unsupported command */
  ...
  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: INCRBYFLOA\r\n",
