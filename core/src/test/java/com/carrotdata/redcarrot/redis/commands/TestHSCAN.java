...
public class TestHSCAN extends CommandBase {
  ...
  protected String[] validRequests = new String[] {
      "HSET key v10 a v11 a v12 a v13 a v14 a v15 a v20 a v21 a v22 a v23 a v24 a v25 a v30 a v31 a v32 a v33 a v34 a v35 a"
          + " a10 a a11 a a12 a a13 a a14 a a15 a a20 a a21 a a22 a a23 a a24 a a25 a a30 a a31 a a32 a a33 a a34 a a35 a", /*
                                                                                                                             * 36
                                                                                                                             */
      "HLEN key", /* 36 */
      "hscan key 0", "HSCAN key 1", "HSCAN key 2", "HSCAN key 3", "HSCAN key 4", "HSCAN key 5",
      "HSCAN key 6", "HSCAN key 7", "HSCAN key 8", "HSCAN key 0 COUNT 20", "HSCAN key 10 COUNT 20",
      "HSCAN key 11 COUNT 20", "HSCAN key 12 COUNT 20", "hscan key 13 count 20",

      // Scan all which start with 'a'
      "HSCAN key 0 MATCH ^a.* COUNT 20", "HSCAN key 15 MATCH ^a.* COUNT 20",
  ...
  protected String[] invalidRequests = new String[] { "HSCAN", /* wrong number of arguments */
