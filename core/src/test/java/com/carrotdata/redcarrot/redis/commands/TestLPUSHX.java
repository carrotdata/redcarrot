...
public class TestLPUSHX extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "LPUSHX key v1 v2 v3 v4 v5 v6 v7 v8 v9 v10", /*
                                                                                                  * -1
                                                                                                  */
  ...
  protected String[] invalidRequests = new String[] { "lpshx x y", /* unsupported command */
      "LPUSHX", /* wrong number of arguments */
      "LPUSHX key", /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: LPSHX\r\n",
