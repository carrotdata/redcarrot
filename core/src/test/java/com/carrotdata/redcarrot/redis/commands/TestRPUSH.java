...
public class TestRPUSH extends CommandBase {
  ...
  protected String[] validRequests = new String[] { "RPUSH key v1 v2 v3 v4 v5 v6 v7 v8 v9 v10", /*
                                                                                                 * 10
                                                                                                 */
  ...
  protected String[] invalidRequests = new String[] { "rpus x y", /* unsupported command */
      "RPUSH", /* wrong number of arguments */
      "RPUSH key", /* wrong number of arguments */
  };

  protected String[] invalidResponses = new String[] { "-ERR: Unsupported command: RPUS\r\n",
