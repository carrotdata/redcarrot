...
public class TestSETEX extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "SETEX key 100000 value", /* OK */ "setex key 1000000 value" /* OK */ };

  protected String[] validResponses = new String[] { "+OK\r\n", "+OK\r\n" };

  protected String[] invalidRequests = new String[] { "setexx x y", /* unsupported command */
  ...
  protected String[] invalidResponses =
      new String[] { "-ERR: Unsupported command: SETEXX\r\n", "-ERR: Wrong number of arguments\r\n",
          "-ERR: Wrong number of arguments\r\n", "-ERR: Wrong number of arguments\r\n",
