...
public class TestZREMRANGEBYLEX extends CommandBase {
  ...
  protected String[] validRequests =
      new String[] { "ZADD key 0 c1 0 c2 0 c3 0 c4 0 c5 0 c6 0 c7 0 c8 0 c9 0 c10", /* 10 */
          "ZCARD key", /* 10 */
  ...
  protected String[] invalidRequests = new String[] { "zremrangebylux x y", /*
                                                                             * unsupported command
                                                                             */
  ...
  protected String[] invalidResponses =
      new String[] { "-ERR: Unsupported command: ZREMRANGEBYLUX\r\n",
