...
public interface RedisCommand {
  ...
  static final long PERSISTS_FLAG_LOWER =
      UnsafeAccess.allocAndCopy("persist", 0, "persist".length());
  ...
  static final long KEEPTTL_FLAG_LOWER =
      UnsafeAccess.allocAndCopy("keepttl", 0, "keepttl".length());
  ...
  static final long WITHVALUES_FLAG =
      UnsafeAccess.allocAndCopy("WITHVALUES", 0, "WITHVALUES".length());
  static final long WITHVALUES_FLAG_LOWER =
      UnsafeAccess.allocAndCopy("withvalues", 0, "withvalues".length());
  ...
  static final long WITHSCORES_FLAG =
      UnsafeAccess.allocAndCopy("WITHSCORES", 0, "WITHSCORES".length());
  static final long WITHSCORES_FLAG_LOWER =
      UnsafeAccess.allocAndCopy("withscores", 0, "withscores".length());
  ...
  static final long SCHEDULE_FLAG_LOWER =
      UnsafeAccess.allocAndCopy("schedule", 0, "schedule".length());
  ...
  static final long MEMORY_LOWER_CASE_FLAG =
      UnsafeAccess.allocAndCopy("memory", 0, "memory".length());
