...
public class ZRANGEBYSCORE implements RedisCommand {
  ...
  /** TODO: v. 6.2 support LIMIT offset count ZRANGEBYSCORE key min max [WITHSCORES] */
  @Override
  public void execute(BigSortedMap map, long inDataPtr, long outBufferPtr, int outBufferSize) {
    try {
      ...
      int size = (int) ZSets.ZRANGEBYSCORE(map, keyPtr, keySize, start, startInclusive, end,
        endInclusive, withScores, outBufferPtr + off, outBufferSize - off);
