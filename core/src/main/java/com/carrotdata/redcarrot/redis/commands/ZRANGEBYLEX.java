...
public class ZRANGEBYLEX implements RedisCommand {
  ...
  /** TODO: v 6.2 support ZRANGEBYLEX key min max */
  @Override
  public void execute(BigSortedMap map, long inDataPtr, long outBufferPtr, int outBufferSize) {
    try {
      ...
      int size = (int) ZSets.ZRANGEBYLEX(map, keyPtr, keySize, startPtr, startSize, startInclusive,
        endPtr, endSize, endInclusive, outBufferPtr + off, outBufferSize - off);
