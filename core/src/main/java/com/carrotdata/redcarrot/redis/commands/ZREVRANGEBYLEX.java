...
public class ZREVRANGEBYLEX implements RedisCommand {
  ...
  /** TODO: v 6.2 support ZREVRANGEBYLEX key min max */
  @Override
  public void execute(BigSortedMap map, long inDataPtr, long outBufferPtr, int outBufferSize) {
    try {
      ...
      int size = (int) ZSets.ZREVRANGEBYLEX(map, keyPtr, keySize, startPtr, startSize,
        startInclusive, endPtr, endSize, endInclusive, outBufferPtr + off, outBufferSize - off);
