...
public abstract class CarrotCoreBase2 {
   ...
   * orphanCounts are equals which is: "CarrotCoreBase2.finalTearDown; Number of tests with objects
   * leaks: 0"
   */
  @AfterClass
  public static void printTestStatistics() {
    log.debug(
        "CarrotCoreBase2.finalTearDown; Number of objects with memory leaks is: {}",
