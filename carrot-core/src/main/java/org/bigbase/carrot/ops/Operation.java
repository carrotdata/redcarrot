...
/**
 * This class encapsulates read-modify-write transactional access pattern. Subclasses must provide
 * key (address, size), version and implement execute() operation. The result can be one or two
 * PUTs, which will be executed in the context of this atomic operation or one Delete and PUT or no
 * updates at all
 */
